...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { name: @version.name, parent_id: @version.parent_id, release_date: @version.release_date }
    end
  ...
  test "should update version" do
    patch :update, id: @version, version: { name: @version.name, parent_id: @version.parent_id, release_date: @version.release_date }
    assert_redirected_to version_path(assigns(:version))
  end
